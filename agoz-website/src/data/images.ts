...
export const images = {
  ...
  prepare: photo(
    'prepare',
    'hf_20260923_092802_5437645d-c750-4ecd-93ea-f8478ca5ef16',
    'הכנת הקרקע בגינה — שטח מיושר עם חוטי סימון ויתדות לפני תחילת העבודה',
    '16 / 9',
    '#7d7059',
  ),
  paving: photo(
    'paving',
    'hf_20260923_092803_40fa89ff-484b-4850-9e7b-ec5fc0e3eab5',
    'הנחת ריצוף אבן טבעית בגינה — חלק מהמרצפות מונחות והשאר במצע מוכן',
    '16 / 9',
    '#8d8269',
  ),
  planting: photo(
    'planting',
    'hf_20260923_092803_01278f35-7815-486f-8860-de7d90fb8b11',
    'שלב השתילה בגינה — שתילים צעירים בערוגות טריות וצמחים בעציצים ממתינים',
    '16 / 9',
    '#5f6942',
  ),
  ctaBackdrop: photo(

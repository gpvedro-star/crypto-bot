...
export function ToolsSection({ tools, articles }: { tools: AITool[]; articles: ArticleWithMeta[] }) {
  return (
    <section aria-labelledby="tools-heading" className="container-x">
      <SectionHeading id="tools-heading" title="AI tools, explained" kicker="The tools desk" description="What each tool is, who it is for, and whether it is worth your time." href="/tools" linkLabel="All tools" />
      ...
      <p className="mt-8 font-sans text-[0.88rem] text-ink-500">
